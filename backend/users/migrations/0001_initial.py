# Generated by Django 4.2.7 on 2025-08-08 12:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depression_level', models.IntegerField(blank=True, null=True)),
                ('sleep_quality', models.IntegerField(blank=True, null=True)),
                ('energy_level', models.IntegerField(blank=True, null=True)),
                ('has_consented_to_data_collection', models.BooleanField(default=False)),
                ('has_consented_to_terms', models.BooleanField(default=False)),
