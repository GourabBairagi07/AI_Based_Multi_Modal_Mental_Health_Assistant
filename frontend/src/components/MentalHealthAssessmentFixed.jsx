...
import { Mic, Video, Type, Send, X, Loader2, MessageSquare, Phone, Video as VideoIcon } from 'lucide-react';
...
const MentalHealthAssessment = () => {
  ...
  const handleChatSubmit = async (e) => {
    ...
    // Mock response - replace with Gemini API call
    setTimeout(() => {
      const responses = [
                  ...
                  >
                    ...
                    <form onSubmit={handleTextSubmit} className="flex space-x-2">
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-purple-500/30 transition-all flex items-center justify-center disabled:opacity-50 hover:-translate-y-0.5 transform transition-transform"
                      >
                    ...
                    <div className="flex items-center space-x-4">
                      <button
                        ...
                        className={`p-4 rounded-xl ${
                          isRecording ? 'bg-red-500 animate-pulse' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
                        } text-white hover:shadow-lg transition-all hover:-translate-y-0.5 transform`}
                      >
                        {isRecording ? (
                    ...
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      <div className="flex space-x-4">
                        <button
                          ...
                          className={`px-5 py-2.5 rounded-xl flex items-center space-x-2 ${
                            isCameraOn ? 'bg-red-500' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
